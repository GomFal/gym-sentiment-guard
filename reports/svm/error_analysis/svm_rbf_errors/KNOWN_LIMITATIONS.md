...
|-----------|----------|------------|------------|
| **Overall** | 100% | 0.0483 | — |
| Low-coverage | 6.8% | 0.0571 | +0.0088 |
| Has-contrast | 18.1% | 0.1067 | +0.0584 |
...
1. **Probability is near threshold (0.50)**: 23 errors occurred in the uncertainty band.
...
4. **Model is highly confident but wrong**: 42 high-confidence errors detected.
