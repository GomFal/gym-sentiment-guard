...
|-----------|----------|------------|------------|
| **Overall** | 100% | 0.042 | — |
| Low-coverage | 6.8% | 0.0643 | +0.0223 |
| Has-contrast | 18.1% | 0.1013 | +0.0593 |
...
1. **Probability is near threshold (0.50)**: 18 errors occurred in the uncertainty band.
...
4. **Model is highly confident but wrong**: 41 high-confidence errors detected.
