...
def _compute_test_metrics_from_predictions(predictions_df: pd.DataFrame, threshold: float) -> dict[str, float]:
    """
...
def generate_ablation_report(
    ...
    stopwords_fig_path = plot_stopwords_effect(df_sorted, figures_dir / 'layer3_stopwords_effect.png')
    ...
    if test_predictions_path is not None:
        ...
        if test_predictions_path.exists():
            ...
            # PR curve
            pr_path = plot_pr_curve_neg(y_true, p_neg, threshold, figures_dir / 'layer4_pr_curve_neg.png')
            ...
            # Calibration curve
            cal_path = plot_calibration_curve(y_true, p_neg, figures_dir / 'layer4_calibration_curve.png')
